...
for user in iam.list_users()['Users']:
    ...
    print(time)
    if time>60 and user['UserName']!='Admin':    #change the time in minutes according to your need, this will delete the user which has been created from last specified time. 
...
for user in user_name:
    user1 = iam.User(user)
    user1.detach_policy(PolicyArn='arn:aws:iam::aws:policy/AmazonEC2FullAccess')
